    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            <tr>
                ...
                <th scope="col"><?= __('Nm Email Alerts') ?></th>
                <th scope="col"><?= __('Last Alert Article Id') ?></th>
            ...
            <tr>
                ...
                <td><?= h($users->author) ?></td>
                <td><?= h($users->picture) ?></td>
                <td><?= h($users->nm_email_alerts) ?></td>
                <td><?= h($users->last_alert_article_id) ?></td>
